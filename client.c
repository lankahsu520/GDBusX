...
void Agent_start(void)
{
	...
	gbusx_start(gbusx_req, "thread_gbusx_agent", gbusx_dummy_thread_handler, gbusx_proxy_register_Agent_cb, NULL, NULL, &gbusx_name_lost_cb);
...
void Boss_start(void)
{
	...
	gbusx_req->isservice = is_service;
	gbusx_start(gbusx_req, "thread_gbusx_boss", gbusx_dummy_thread_handler, gbusx_proxy_register_Boss_cb, NULL, NULL, &gbusx_name_lost_cb);
